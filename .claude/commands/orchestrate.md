...
4. **한 줄 결과만 수신**: "DONE:T1.3" 또는 "FAIL:T1.3:reason"
...
Task(subagent_type="backend-specialist", run_in_background=true, max_turns=20, prompt="... T1.1 ...")
Task(subagent_type="frontend-specialist", run_in_background=true, max_turns=20, prompt="... T1.2 ...")
