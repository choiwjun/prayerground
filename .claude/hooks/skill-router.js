...
const SKILL_DEFINITIONS = {
  ...
  'parallel-orchestra': {
    description: 'Parallel specialist orchestration for multi-lane work',
    keywords: ['병렬 에이전트', '병렬 작업', '오케스트라', '오케스트라 스킬', 'parallel agent', 'parallel agents', 'parallel orchestra', 'multi agent', 'planner coder reviewer', 'planner researcher coder reviewer'],
    priority: 8
  },
  ...
  'eros': {
    description: '플라톤 향연 기반 결핍 인식 → 디오티마 사다리 → 창작',
    keywords: ['에로스', 'eros', '결핍 인식', '디오티마', '추상화 사다리', '던닝크루거', '결핍'],
    priority: 6
  },
  'packaging': {
